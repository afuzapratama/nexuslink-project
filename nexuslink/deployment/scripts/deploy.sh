...
cat << "EOF"
╔═══════════════════════════════════════╗
║   NexusLink Production Deployment    ║
║         Automated Installer          ║
╚═══════════════════════════════════════╝
EOF
echo -e "${NC}"
...
EOF
        ...
        echo -e "${YELLOW}⚠️  .env file created - PLEASE UPDATE IT!${NC}"
...
install_systemd_service() {
    ...
    if [ -f "$service_file" ]; then
        ...
        echo -e "${GREEN}✅ Service nexuslink-${service} installed${NC}"
    else
